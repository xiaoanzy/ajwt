...
public class ExpirationException extends RuntimeException {
    ...
    public ExpirationException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    protected ExpirationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
